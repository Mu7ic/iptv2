                            ...
                            <div class="mb-3 mb-md-0 mb-lg-0 s-v-content tn">
                                <div class="s-video-p">
                                    <video poster="<?= Yii::$app->request->baseUrl; ?>/includes/img/vbg.png" id="player"
                                        ...
                                        <source src="http://<?php  $domain=parse_url($_SERVER['HTTP_REFERER'], PHP_URL_HOST); if($domain=="192.168.100.12") echo $ip; else echo "217.11.179.169";/*elseif($domain=="iptv.robita.tj") echo '217.11.179.169';else echo $ip;*/ ?>:<?php if($ip=="192.168.100.33") echo '9981'; elseif($ip=="192.168.100.35") echo '9982'; ?>/stream/channelid/<?= $id; ?>?profile=webtv-vp8-vorbis-webm">
                                    </video>
                                </div>
                            </div>
                        </div>
